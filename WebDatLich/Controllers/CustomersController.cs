...
namespace WebDatLich.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(AppointmentschedulerContext context)
        {
            _context = context;
        }
        ...
        {
            var appointmentschedulerContext = _context.Customers.Include(c => c.IdCustomerNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdCustomer")] Customer customer)
        {
            ...
            ViewData["IdCustomer"] = new SelectList(_context.Users, "Id", "Id", customer.IdCustomer);
            return View(customer);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCustomer")] Customer customer)
        {
