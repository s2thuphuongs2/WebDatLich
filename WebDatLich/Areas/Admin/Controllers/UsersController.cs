...
namespace WebDatLich.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(AppointmentschedulerContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Password,FirstName,LastName,Email,Mobile,Street,City")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
