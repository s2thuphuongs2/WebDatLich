...
namespace WebDatLich.Areas.Admin.Controllers
{
    ...
    public class AdminInvoicesController : Controller
    {
        ...
        public AdminInvoicesController(AppointmentschedulerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Number,Status,TotalAmount,Issued")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Number,Status,TotalAmount,Issued")] Invoice invoice)
        {
            if (id != invoice.Id)
            {
                return NotFound();
